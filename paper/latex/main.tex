...
A deterministic post-hoc qualitative audit selects the maximum-risk error and minimum-risk correct consensus in the Qwen high-consensus subset; it is illustrative only and does not alter any formal metric or gate (Appendix~\ref{sec:tail}).
...
\bottomrule
\end{tabular}
\caption{Label-wise asymmetry sequence. BoolQ and V3.15.2 are diagnostic precursors; V3.16 is the balanced follow-up. Rows are not pooled into one test.}
