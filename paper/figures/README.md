...
writes vector PDF figures for LaTeX and 320-dpi PNG previews. The risk--coverage
curve is descriptive except for the preregistered 80% coverage operating point;
the generated `routing_curve_data.json` preserves that boundary explicitly.
