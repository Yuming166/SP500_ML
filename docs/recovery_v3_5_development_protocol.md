# Recovery V3.5 development protocol: PACE

Protocol candidate: `recovery-v3.5-pace-ex-fever-2026-09-02`

Status: **development only; written before any EX-FEVER model call**.

## Goal and separation from prior work

V3.5 leaves every V1--V3.4.1 artifact and conclusion unchanged. It develops a
