# Recovery V3.5.2 preregistration: PACE action certificates

Protocol version: `recovery-v3.5.2-pace-ex-fever-2026-09-02`

Status: **frozen before resuming/completing development action collection and
fitting, and before any formal EX-FEVER test call**.

## Prior-result and development boundary

V3.5.2 does not modify V1--V3.5.1. In particular, the negative prospective
...
V3.5.1 subsequently stopped after 105 complete development action bundles and
before fitting or formal calls. One `both` action cited the nonexistent `C01`,
which cannot be uniquely interpreted as `C001` or `C101`, and its fixed retry
repeated the violation. V3.5.2 projects every action citation list onto unique,
exactly matching packet IDs and records rejected strings. It performs no fuzzy
ID repair and does not change answer or confidence. The projection can only
decrease citation-based support counts. This second schema amendment was frozen
before resuming development and used neither a complete development outcome
matrix nor any formal outcome.
...
`1a6241aca3ca13c6ad70e814c1e2822e31f687e92c80a4cc8c0877ca5c3a00b4`.
...
`src/sp500_forecastability/recovery_v3_5_2.py`, SHA-256
`299f86cc2f1f370c5a7b89462866b3ce87cf3fef0d959131c038afec65377a50`.
