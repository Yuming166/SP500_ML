...
PROTOCOL_VERSION = "recovery-v3.5.2-pace-ex-fever-2026-09-02"
DEFAULT_ROOT = Path("results/recovery_v3_5_2")
...
PREREGISTRATION = Path("docs/recovery_v3_5_2_preregistration.md")
