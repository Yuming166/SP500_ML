...
PROTOCOL_VERSION = "recovery-v3.6-atomic-pace-ex-fever-development-2026-09-02"
DEFAULT_ROOT = Path("results/recovery_v3_6")
...
PREREGISTRATION = Path("docs/recovery_v3_6_preregistration.md")
