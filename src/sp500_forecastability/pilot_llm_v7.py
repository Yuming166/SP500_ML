...
PROTOCOL_VERSION = "pilot-llm-v7-2026-09-01"
SALT = b"pilot-llm-v5-2026-08-31\n"  # V7 D1_v7: V5's salt for V5 ⊂ V7
# CQID hash uses V5's PROTOCOL_VERSION (NOT V7's) so V5 ⊂ V7 by cqid sort
CQID_PROTOCOL_VERSION = "pilot-llm-v5-2026-08-31"
CQID_PREFIX = "v5"  # cqids are v5-prefixed for V5 ⊂ V7 compat
...
DEFAULT_ROOT = Path("results/pilot_llm_v7")
