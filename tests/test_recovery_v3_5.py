...
from sp500_forecastability import recovery_v3_5 as pace
...
def test_certificate_parser_enforces_new_root_grounding() -> None:
    content = json.dumps(
        {
            "relation": "support",
    ...
    with pytest.raises(ValueError, match="local to the new root"):
        pace.parse_certificate(content.replace("C00", "A00"), ["C00"])
